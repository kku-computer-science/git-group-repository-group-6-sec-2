            ...
            <div class="card-body">
                {!! Form::open(array('route' => 'departments.store', 'method'=>'department')) !!}
                    <div class="form-group">
                        ...
                        {!! Form::text('department_name_TH', null, array('placeholder' => 'department_name_TH','class' => 'form-control')) !!}
                    </div>
                    <div class="form-group">
                        <strong>department_name_EN	:</strong>
                        {!! Form::text('department_name_EN', null, array('placeholder' => 'department_name_EN','class' => 'form-control')) !!}
                    </div>
