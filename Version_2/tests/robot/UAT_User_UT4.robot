...
UT3.2 Test Profile IT
    ...
    Wait Until Element Is Visible    xpath=//a[@href='http://127.0.0.1:8000/researchers/3']    timeout=10s
    Click Element    xpath=//a[@href='http://127.0.0.1:8000/researchers/3']
    Wait Until Location Contains    /researchers/3    timeout=10s

UT3.3 Test Choose IT   
    Page Should Contain    Researchers
    Page Should Contain    Geo-Informatics
UT3.4 Test Ngamnij
