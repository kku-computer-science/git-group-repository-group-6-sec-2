...
2. ผู้ใช้ทั่วไปสามารถเลือกสาขาของนักวิจัยที่ต้องการค้นหา อาทิเช่น Computer Science, Information Technology, Geo-Informatics
...
### **6.3 การดูกราฟแสดงสถิติ**
1. ผู้ใช้ทั่วไปสามารถดูกราฟแสดงสถิติเช่น **ผลรวมจำนวนการตีพิมพ์จากแหล่งต่าง ๆ (Publication)** และ **จำนวนการอ้างอิงทั้งหมด (Citation)** ของนักวิจัยแต่ละท่าน
2. กราฟจะแสดงบนหน้าข้อมูลนักวิจัยพร้อมทั้งข้อมูลเกี่ยวกับงานวิจัย

### **6.4 การเลือกแหล่งข้อมูล**
1. ผู้ใช้สามารถเลือกแสดงข้อมูลผลงานวิจัยจากแหล่งต่าง ๆ ได้แก่ **Scopus**, **Web of Science**, **TCI**, **หนังสือ** และ **ผลงานวิชาการด้านอื่นๆ**
2. ผู้ใช้สามารถดูรายละเอียดผลงานวิจัยเพิ่มเติมได้ที่ **Show More**

### **6.5 การส่งออกข้อมูลเป็น Excel**
3. ผู้ใช้สามารถคลิกที่ปุ่ม **"Export to Excel"** ที่อยู่เหนือแถบค้นหา **"Search"**
4. ระบบจะทำการดาวน์โหลดไฟล์ Excel ที่มีข้อมูลผลงานวิจัยของนักวิจัย
